...
/**
 * Facade interface that abstracts ThingHomeSdk calls used by the app. Keeps the UI dependent only
 * on this contract.
 */
public interface DeviceController {
  ...
  interface RssiCallback {
    void onResult(boolean isSuccess, int rssi);
  }
  ...
  void connectBleDevice(
      java.util.List<com.thingclips.smart.android.ble.builder.BleConnectBuilder> builders);
